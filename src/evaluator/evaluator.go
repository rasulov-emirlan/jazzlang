...
func evalBlockStatement(block *ast.BlockStatement, env *object.Environment) object.Object {
	...
	for _, statement := range block.Statements {
		...
		if result != nil {
			r := result.Type()
			if r == object.OBJ_RETURN_VALUE || r == object.OBJ_ERROR {
				return result
			}
		}
	}
...
func evalInfixExpression(operator string, left, right object.Object) object.Object {
	...
	case left.Type() == object.OBJ_BOOLEAN && right.Type() == object.OBJ_BOOLEAN:
		return evalBooleanInfixExpression(operator, left, right)
	case left.Type() == object.OBJ_STRING && right.Type() == object.OBJ_STRING:
		return evalStringInfixExpression(operator, left, right)
	case left.Type() == object.OBJ_INTEGER && right.Type() == object.OBJ_FLOAT:
		return evalFloatInfixExpression(operator, left, right)
	case left.Type() == object.OBJ_FLOAT && right.Type() == object.OBJ_INTEGER:
		return evalFloatInfixExpression(operator, left, right)
	case left.Type() == object.OBJ_FLOAT && right.Type() == object.OBJ_FLOAT:
		return evalFloatInfixExpression(operator, left, right)
...
func evalBangOperator(o object.Object) object.Object {
	if o.Type() == object.OBJ_INTEGER {
		return newError("cannot apply ! operator to integer")
	}
...
func evalIndexExpression(left, index object.Object) object.Object {
	switch {
	case left.Type() == object.OBJ_ARRAY && index.Type() == object.OBJ_INTEGER:
		return evalArrayIndexExpression(left, index)
	case left.Type() == object.OBJ_HASH:
...
func isError(o object.Object) bool {
	if o != nil {
		return o.Type() == object.OBJ_ERROR
	}
	return false
}
